<template>
  <div
    :class="[
      routeName == 'features' ? 'features-page' : null,
...
export default {
  data() {
    return {
      menuStatus: false,
      title: {
        title: "Ücretsiz deneme sürümlü esnek paketlerimiz",
        content:
          "Uniqyl 14 gün ücretsiz deneme sürmü ile E-ticaret sitenizi oluşturmaya hemen başlayın.",
      },
    };
  },
  computed: {
